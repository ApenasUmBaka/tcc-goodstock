...
class ProductsController {
  ...
  public static async getProductById(req: Request, res: Response) {
    ...
    if (typeof productResult == "string") {
      req.logger.info(`Product not found. Error: ${productResult}. Returning...`);
  ...
  public static async getProductsByQuery(req: Request, res: Response) {
    ...
    if (typeof productsResult == "string") {
      req.logger.info(`Products not found. Error: ${productsResult}. Returning...`);
      return res.status(404).json({
        status: 'Error',
  ...
  public static async postProduct(req: Request, res: Response) {
    ...
    // Return the result.
    if (typeof productResult == "string") {
      req.logger.info(`The product was not created. Error: ${productResult}. Returning...`);
      return res.status(400).json({
        status: 'Error',
  ...
  public static async patchProduct(req: Request, res: Response) {
    ...
    // Return the result.
    if (typeof productResult == "string") {
      req.logger.info(`Product not updated. Error: ${productResult}. Returning...`);
      return res.status(400).json({
        status: 'Error',
  ...
  public static async deleteProduct(req: Request, res: Response) {
    ...
    // Return the result.
    if (typeof productResult == "string") {
      req.logger.info(`Product not deleted. Error: ${productResult}. Returning...`);
      return res.status(400).json({
        status: 'Error',
