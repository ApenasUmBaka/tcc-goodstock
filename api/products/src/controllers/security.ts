...
abstract class Security {
  ...
  /*
    A method to filter the params from some request.
    Use it to get the necessary params from the body with all others params.
  */
  public static filterParamsOptional(neededParams: string[], body: any): any {
    const params: any = this.filterParams(neededParams, body);
